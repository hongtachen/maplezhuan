...
export default function BrowsePage() {
  ...
  return (
    <div className="flex flex-col min-h-full">
      {/* Search Header Area */}
      <header className="sticky top-0 z-40 bg-[#f3fbf7]">
        {/* Mobile brand bar — separated from browse controls */}
        <div className="md:hidden flex items-center justify-between gap-3 px-4 py-3 bg-white border-b border-[rgba(31,41,51,0.08)]">
          <Link href="/" className="shrink-0" aria-label="枫转首页">
            <img
          ...
          <Link
            href="/about"
            className="inline-flex items-center gap-1.5 shrink-0 text-sm font-semibold text-[#2f9e6d] bg-[#f3fbf7] border border-[rgba(47,158,109,0.35)] rounded-full px-4 py-2 hover:bg-white hover:border-[#2f9e6d] active:scale-[0.98] transition-all"
          >
            枫转故事
            <svg
              className="w-4 h-4"
        ...
        <div className="px-4 md:px-8 pt-4 pb-4 md:pt-6">
          <div className="max-w-[1280px] mx-auto">
            ...
            <div className="flex md:hidden items-center gap-2 mb-2 pt-4 border-t border-[rgba(31,41,51,0.08)]">
