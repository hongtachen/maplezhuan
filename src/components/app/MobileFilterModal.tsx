      ...
      <div className="flex-1 min-h-0 overflow-y-auto pb-24">
        {activeTab === "sublet" ? (
          <div className="px-4 py-5 flex flex-col gap-6">
            {/* Location */}
            <div>
              <h3 className="text-sm font-medium text-[#1f2933] mb-3">地点</h3>
            ...
            {/* Term */}
            <div>
              <h3 className="text-sm font-medium text-[#1f2933] mb-3">租期</h3>
              <div className="flex flex-wrap gap-2">
            ...
            {/* Room Type */}
            <div>
              <h3 className="text-sm font-medium text-[#1f2933] mb-3">房型</h3>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="px-4 py-5 flex flex-col gap-6">
            ...
            {/* Category */}
            <div>
              <h3 className="text-sm font-medium text-[#1f2933] mb-3">分类</h3>
