      ...
      <div className="md:max-w-4xl md:mx-auto md:px-8 md:py-8 w-full pb-24 md:pb-32">
        ...
        <div className="px-5 py-6 md:px-0">
          ...
          <div className="text-2xl md:text-3xl font-bold text-[#2f9e6d] mb-2">
            ${item.price}{" "}
            <span className="text-base font-normal text-[#5a6b73]">CAD</span>
          </div>
          ...
          {user?.uid !== item.sellerId ? (
            <div className="w-full flex gap-2">
              ...
              <button
                ...
                className="flex-[1.5] bg-[#2f9e6d] hover:bg-[#267a56] text-white font-bold py-3 rounded-2xl flex items-center justify-center gap-1 transition-colors shadow-md shadow-[#2f9e6d]/20"
              >
                直接购买
              </button>
            </div>
