        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12">
          ...
          <div className="flex flex-col gap-6 md:max-w-[450px] shrink-0 items-start">
            ...
            <h1 className="flex flex-col tracking-[0.35px]">
              <span className="whitespace-nowrap text-[clamp(1rem,calc(100cqi/16),2.1rem)] md:text-fluid-h2 font-semibold text-[#1f2933] leading-[60px]">
                不用加好友，不用刷群翻帖
              </span>
              ...
              <span className=" whitespace-nowrap text-[clamp(1rem,calc(100cqi/16),2.1rem)] md:text-fluid-h2 mt-3 font-semibold text-[#2f9e6d] leading-[60px]">
                价格、状态、位置直接展示
              </span>
            </h1>
